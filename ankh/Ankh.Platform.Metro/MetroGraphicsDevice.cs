...
{
    public class MetroGraphicsDevice : Ankh.GraphicsDeviceBase
    {

        public class Texture : ITexture
        {
            MetroGraphicsDevice dev;
            public D3D11.Texture2D tex;
            ...
            {
                dev._deviceContext.UpdateSubresource(data, tex);
            }
        }
        ...
        protected D3D11.Device1 _device;
