...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	public class DeflaterOutputStream : Stream
	{
		...
		public virtual void Finish()
		{
			...
			if (cryptoTransform_ != null)
			{
#if !NET_1_1 && !NETCF_2_0 && !NET_PORTABLE
		...
		/// </summary>
		protected override void Dispose(bool disposing) //zero 25-aug-2012 - changed from Close
		{
			if ( !isClosed_ ) {
				isClosed_ = true;
				...
				try {
					...
					if( isStreamOwner_ ) {
						baseOutputStream_.Dispose(); //zero 25-aug-2012 - changed from Close
					}
				}
			}
		}
