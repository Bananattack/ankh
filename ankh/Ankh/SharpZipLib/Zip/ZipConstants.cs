...
namespace ICSharpCode.SharpZipLib.Zip 
{
	...
	public sealed class ZipConstants
	{
		...
		public static string ConvertToString(byte[] data, int count)
		{
			...
			return Encoding.UTF8.GetString(data, 0, count); //zero 25-aug-2012 - changed from something to UTF8
		}
		...
		public static byte[] ConvertToArray(string str)
		{
			...
			return Encoding.UTF8.GetBytes(str); //zero 25-aug-2012 - changed from something to UTF8
		}
